 ...
 *
 * Please comment/correct/improve these notes via github. Proposals or questions 
 * can be submitted as an "issue"; proposals for corrections / extensions / 
 * improvements can be submitted as a "pull request". You can of course also 
 * send an email to Klaus Ostermann */
